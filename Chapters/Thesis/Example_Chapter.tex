...
To accommodate later evaluations using feature-related concerns of a commit and feature overlap factors, we create reports featuring a more complex datatype than a sole structural CFI.
