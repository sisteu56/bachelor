...
- the other commit encompassed many different responsibilites changing 118 files and over 3000 lines of code \\
...
- \\
- in a second restriction, we exclude commits we determined to be exceptionally large in our computation of the average numbers of features changed \\
