...
We refine our investigation by factoring in the nesting degrees of features \ref{def:nesting_degree}. 
...
For a simpler recognition of a distribution, the features are sorted in an increasing order according to their value in the metric of the respective plot.
