...
Seeing how greatly this proportion varies between features could also tell whether one could be used a predictor for the other.
...
Our main focus lies on outside commits however, as the set of inside commits interacting with a feature through dataflow mostly matches the set of commits structurally interacting with it.
