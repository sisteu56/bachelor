...
In \autoref{ch:example_chapter}, we dicussed the different meanings of structural and dataflow-based interactions.
With this knowledge, investigate patterns in feature development and usage of commits therin as well as findings about how likely seemingly unrelated commits are to affect features inside a program.
...
The projects we investigate in this work, \textsc{xz}, \textsc{gzip}, \textsc{bzip2} and \textsc{lrzip} are listed in \autoref{tab:examined_projects}.
...
\midrule
  ...
  gzip  & \math{626048} & \math{22198} & \math{14} \\
