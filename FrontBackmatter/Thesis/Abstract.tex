...
We derive a best practice for commits, namely that commits should usually deal with only one feature-related responsibility, which we find to be enforced for the majority of commits (>70\%).% in our examined projects. 
